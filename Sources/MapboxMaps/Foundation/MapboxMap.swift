...
extension MapboxMap {
    ...
    public func setFeatureState(sourceId: String, sourceLayerId: String?, featureId: String, state: [String: Any]) {
    ...
    ///   - sourceLayerId: The style source layer identifier (for multi-layer sources such as vector sources)
    ///   - featureId: The feature identifier of the feature whose state should be removed
    ///   - stateKey: The key of the property to remove. If `nil`, all feature's state object properties are removed.
    public func removeFeatureState(sourceId: String, sourceLayerId: String?, featureId: String, stateKey: String?) {
